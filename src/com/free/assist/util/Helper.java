...
public class Helper {
	...
	public static ActionForm setQueryParam(ActionForm form, String queryParamName) {
		try {
			...
			Method method = clazz.getDeclaredMethod("get" + queryParamName.substring(0, 1).toUpperCase() + queryParamName.substring(1), (Class[]) null);
			...
			if (sbf != null && !"".equals(sbf.toString().trim())) {
				method = clazz.getDeclaredMethod("set" + queryParamName.substring(0, 1).toUpperCase() + queryParamName.substring(1), String.class);
	...
	private static StringBuffer getAllClassProp(Method[] methods, String allQueryParamName, String paramSeparator, String paramValueSeparator, ActionForm form, StringBuffer sbf) throws Exception {
	...
	public static void setClassProp(Method[] methods, String[] allQueryParamArray, String paramSeparator, String paramValueSeparator, ActionForm form) throws Exception {
		String methodName = null;
		String strParameterName = null;
		...
		for (int i = 0; i < methods.length; i++) {
			...
			if (methodName.startsWith("set")) {
				...
				for (String queryParamNameValue : allQueryParamArray) {
					...
					if (strParameterName.equals(queryParamNameValueArray[0]) && queryParamNameValueArray[1] != null && !"".equals(queryParamNameValueArray[1].trim())) {
	...
	public static Date switchDate(String str) {
		String format = null;
		if (Pattern.compile("^((((1[6-9]|[2-9]\\d)\\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\\d|3[01]))|(((1[6-9]|[2-9]\\d)\\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\\d|30))|(((1[6-9]|[2-9]\\d)\\d{2})-0?2-(0?[1-9]|1\\d|2[0-8]))|(((1[6-9]|[2-9]\\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-)) (20|21|22|23|[0-1]?\\d):[0-5]?\\d:[0-5]?\\d$").matcher(str).find()) {
			format = "yyyy-MM-dd HH:mm:ss";
		} else if (Pattern.compile("^((((1[6-9]|[2-9]\\d)\\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\\d|3[01]))|(((1[6-9]|[2-9]\\d)\\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\\d|30))|(((1[6-9]|[2-9]\\d)\\d{2})-0?2-(0?[1-9]|1\\d|2[0-8]))|(((1[6-9]|[2-9]\\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))$").matcher(str).find()) {
			format = "yyyy-MM-dd";
		} else if (Pattern.compile("^((((1[6-9]|[2-9]\\d)\\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\\d|3[01]))|(((1[6-9]|[2-9]\\d)\\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\\d|30))|(((1[6-9]|[2-9]\\d)\\d{2})-0?2-(0?[1-9]|1\\d|2[0-8]))|(((1[6-9]|[2-9]\\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-)) (20|21|22|23|[0-1]?\\d):[0-5]?\\d$").matcher(str).find()) {
