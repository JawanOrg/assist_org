...
public class BusLinePipeKnowledgeExample extends BaseExample {
    protected String orderByClause;

    protected List<Criteria> oredCriteria;

    public BusLinePipeKnowledgeExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected BusLinePipeKnowledgeExample(BusLinePipeKnowledgeExample example) {
