...
public class BusReleaseTrendsExample  extends BaseExample{
    protected String orderByClause;

    protected List<Criteria> oredCriteria;

    public BusReleaseTrendsExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected BusReleaseTrendsExample(BusReleaseTrendsExample example) {
