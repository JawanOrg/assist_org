...
public class BusReleaseActualExample extends BaseExample {
	...
	public static class Criteria {
		...
		public Criteria andMySendOrReceive(String unitId, String unitName) {
			addCriterion(" (CREATE_DEPT = '" + unitId + "' or  instr(','|| (select WMSYS.WM_CONCAT(u.unit_name) From t_supt_notice_object n,t_sys_unit u where n.object_id=u.unit_id and n.object_type!='E' and n.bill_id=T_BUS_RELEASE_ACTUAL.BILL_ID GROUP BY n.bill_id) ||',','" + unitName + "')>0)");
			return this;
		}
	}
}