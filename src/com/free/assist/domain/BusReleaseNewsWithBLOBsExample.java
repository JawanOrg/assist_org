...
public class BusReleaseNewsWithBLOBsExample  extends BaseExample{
    protected String orderByClause;

    protected List<Criteria> oredCriteria;

    public BusReleaseNewsWithBLOBsExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected BusReleaseNewsWithBLOBsExample(BusReleaseNewsWithBLOBsExample example) {
