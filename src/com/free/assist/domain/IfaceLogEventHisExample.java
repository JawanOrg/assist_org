...
public class IfaceLogEventHisExample extends BaseExample {
    protected String orderByClause;

    protected List<Criteria> oredCriteria;

    public IfaceLogEventHisExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected IfaceLogEventHisExample(IfaceLogEventHisExample example) {
    ...
    public static class Criteria {
        ...
        public Criteria andSuccessfulLike(String value) {
            addCriterion("SUCCESSFUL like", value, "successful");
            return this;
        }

        public Criteria andSuccessfulNotLike(String value) {
            addCriterion("SUCCESSFUL not like", value, "successful");
            return this;
        }
