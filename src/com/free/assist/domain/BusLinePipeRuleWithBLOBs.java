 ...
 * <p>该实体对应数据库的表名为：T_BUS_LINEPIPE_RULE。</p>
...
public class BusLinePipeRuleWithBLOBs extends BusLinePipeRule implements Serializable {
    private String roleContent;

    private static final long serialVersionUID = 1L;

    @javax.persistence.Column(name="ROLE_CONTENT", nullable=false)
