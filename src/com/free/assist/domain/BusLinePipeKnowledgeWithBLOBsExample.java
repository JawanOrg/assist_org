...
public class BusLinePipeKnowledgeWithBLOBsExample extends BaseExample{
    protected String orderByClause;

    protected List<Criteria> oredCriteria;

    public BusLinePipeKnowledgeWithBLOBsExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected BusLinePipeKnowledgeWithBLOBsExample(BusLinePipeKnowledgeWithBLOBsExample example) {
