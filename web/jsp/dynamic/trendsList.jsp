	...
	<c:forEach items="${requestScope.trendsList}" var="obj" varStatus="n">
		<tr bgcolor="" style="cursor: 'hand'">
			<td align="left" title="${obj.theTitle}"><a herf="#"
				onclick="getDetail('${obj.billId}','${obj.theTitle}')">${fn:length(obj.theTitle)>10?fn:substring(obj.theTitle,0,10):obj.theTitle}${fn:length(obj.theTitle)>10?"...":""}</a><br>
				<fmt:formatDate value="${obj.repairTime}" type="both"
					pattern="MM月dd日" /></td>
