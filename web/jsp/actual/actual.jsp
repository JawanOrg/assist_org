...
<body bgcolor="#FFFFFF" leftmargin="0" marginwidth="0" marginheight="0"
	...
	<script>
		...
		function addActual() {
			ymPrompt.win({
				message : '/business/actualAction.do?method=addActualInit',
				width : 800,
				height : 500,
				title : '',
				minBtn : false,
		...
		function modifyActual(billId) {
			ymPrompt.win({
				message : '/business/actualAction.do?method=modifyActualInit&billId=' + billId,
				width : 800,
				height : 500,
				title : '',
				minBtn : false,
