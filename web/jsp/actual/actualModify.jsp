					...
					<tr>
						<td valign="top">
							<table height="100%" width=90% border=0 cellpadding=2
								...
								<tr>
									<td noWrap>
										<div align="right">地址<span style="color:Red">*</span>：</div>
									</td>
									<td align="left" colspan="2"><input
															name="address" type="text" id="theTitle"
															class="form-control"
															dataType="Require" msg="'地址'必填" value="${requestScope.address}"/></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
								<tr>
									<td noWrap>
										<div align="right">描述<span style="color:Red">*</span>：</div>
									</td>
									<td align="left" colspan="2"><textarea id="actualContent"
											name="actualContent" class="form-control" rows="3" >${requestScope.actualContent}</textarea></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
								<tr>
									<td colspan="3" align="center"><input name="auditBtn"
										...
										value="确定" onclick="modifyActual(this)"> &nbsp;&nbsp; <input
