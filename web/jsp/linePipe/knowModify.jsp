							...
							<table height="100%" width=90% border=0 cellpadding=2
								...
								<tr>
									...
									<td align="left" colspan="2"><textarea id="linePipeContent"
											name="linePipeContent" class="form-control" rows="3" dataType="Require" msg="'识别方法'必填" >${requestScope.knowContent}</textarea></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
								<tr>
									<td colspan="3" align="center"><input name="auditBtn"
										...
										value="确定" onclick="modifyKnow(this)"> &nbsp;&nbsp; <input
