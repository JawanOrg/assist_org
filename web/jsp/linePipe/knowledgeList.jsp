...
<table class=table id=powergrid style="FONT-SIZE: 13px" cellspacing=0
	...
	<tbody>
		<tr class="titletr">
			...
			<td style="word-break: keep-all;">常识内容</td>
		...
		<c:forEach items="${requestScope.linePipeList}" var="obj" varStatus="n">
			<tr align="center" bgcolor="" style="cursor: 'hand'">
				...
				<td align="left" width="52%">${fn:length(obj.knowledgeContent)>50?fn:substring(obj.knowledgeContent,0,50):obj.knowledgeContent}</td>
				...
				<td align="center" width="13%"><input type="button"
											...
											onclick="modifyKnowledge('${obj.contentId}')" /> <input type="button"
											class="btn btn-default btn-sm" value="删除(D)" accesskey="D"
											onclick="deleteKnowledge('${obj.contentId}')" /></td>
			</tr>
		</c:forEach>
	</tbody>
</table>
