		...
		<tr>
			<td width="690" valign="top">
				<table class="gx-show-wrap" width="100%" border="0" cellspacing="0"
					cellpadding="0">
					<tr>
						<td class="gx-show-path">首页 》<strong>管线常识</strong></td>
					</tr>
					<tr>
						<td valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="10">
								<tr>
									<td class="gx-show-titleName">${requestScope.pipeKnowledge.theTitle}</td>
								</tr>
								<tr>
									<td class="gx-show-info">来自： &nbsp;&nbsp;作者：<assist:sysOrganization
											objectId="${requestScope.pipeKnowledge.creator}"></assist:sysOrganization>&nbsp;&nbsp;时间：<fmt:formatDate
											value="${requestScope.pipeKnowledge.createTime}"
											pattern="yyyy-MM-dd hh:mm:ss" /></td>
								</tr>
								<tr>
									<td class="gx-show-content">${requestScope.pipeKnowledge.knowledgeContent}
									</td>
								</tr>
							</table>
						</td>
