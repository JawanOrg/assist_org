					...
					<tr>
						<td valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="10">
								<tr>
									<td class="gx-show-titleName">${requestScope.news.theTitle}</td>
								</tr>
								<tr>
									<td class="gx-show-info">来自： &nbsp;&nbsp;作者：<assist:sysOrganization
											objectId="${requestScope.news.creator}"></assist:sysOrganization>&nbsp;&nbsp;时间：<fmt:formatDate
											value="${requestScope.news.createTime}"
											pattern="yyyy-MM-dd hh:mm:ss" /></td>
								</tr>
								<tr>
									<td class="gx-show-content">${requestScope.news.newsContent}
									</td>
								</tr>
							</table>
						</td>
